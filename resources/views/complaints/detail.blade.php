            ...
            <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 text-sm">
                    ...
                    <div>
                        ...
                        <p class="font-medium mt-1">
                            {{ $complaint->nlp_confidence
                                ? round($complaint->nlp_confidence * 100, 1) . '%'
                                : 'N/A' }}
                        </p>
                    </div>
                    <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        @if($complaint->current_status !== 'in_review')
                            <form method="POST"
                                ...
                                @csrf
                                <div class="mb-3">
                                    <label class="text-xs text-slate-500 font-semibold uppercase">
                                        Add Note (Optional)
                                    </label>
                    ...
                    <div class="space-y-3">
                        @foreach($complaint->updates->sortByDesc('updated_at') as $update)
                            <div class="flex gap-4 text-sm border-b border-slate-100 pb-3">
                                <div class="w-36 shrink-0 text-xs text-slate-400">
